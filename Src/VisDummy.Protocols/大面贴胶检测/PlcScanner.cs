...
{
    public class 大面贴胶检测Scanner : S7PlcScanner<DevMsg, MstMsg>
    {
        private readonly IMediator _mediator;

        public 大面贴胶检测Scanner(IMediator mediator, IServiceScopeFactory ssf, ILogger<S7PlcScanner<DevMsg, MstMsg>> logger, IOptionsMonitor<S7ScanOpt> scanOpts, S7PlcMgr plcMgr)
        ...
        public override string ScanName => PlcNames.PLCNAME_大面贴胶检测;
