...
{
    public class 极性检测2Scanner : S7PlcScanner<DevMsg, MstMsg>
    {
        private readonly IMediator _mediator;

        public 极性检测2Scanner(IMediator mediator, IServiceScopeFactory ssf, ILogger<S7PlcScanner<DevMsg, MstMsg>> logger, IOptionsMonitor<S7ScanOpt> scanOpts, S7PlcMgr plcMgr)
        ...
        public override string ScanName => PlcNames.PLCNAME_极性检测2;
        ...
        public override async Task<DevMsg> GetDevMsgAsync(S7ScanOpt scanOpt)
        {
            ...
            //var ss = Marshal.SizeOf<DevMsg>();
            //var sss = Marshal.SizeOf<MstMsg>();
            if (read.IsError)
            {
