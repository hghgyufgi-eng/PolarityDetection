...
namespace VisDummy.WPF.Views.Monitor.CommonCtrl.极性检测
{
    ...
    /// </summary>
    public partial class 极性检测Station2DSpotCtrl : UserControl, INotifyPropertyChanged
    {
        public 极性检测Station2DSpotCtrl()
        {
            InitializeComponent();
        }
        ...
        public static readonly DependencyProperty DevMsgProperty =
            DependencyProperty.Register("DevMsg", typeof(DevMsg_2DSpotStation), typeof(极性检测Station2DSpotCtrl), new PropertyMetadata(null, DevMsgCallBack));
        ...
        {
            if (d is 极性检测Station2DSpotCtrl ctrl)
            {
        ...
        public static readonly DependencyProperty MstMsgProperty =
            DependencyProperty.Register("MstMsg", typeof(MstMsg_2DSpotStation), typeof(极性检测Station2DSpotCtrl), new PropertyMetadata(null, MstMsgCallBack));
        ...
        public static readonly DependencyProperty PrefixProperty =
            DependencyProperty.Register("Prefix", typeof(string), typeof(极性检测Station2DSpotCtrl), new PropertyMetadata(""));
