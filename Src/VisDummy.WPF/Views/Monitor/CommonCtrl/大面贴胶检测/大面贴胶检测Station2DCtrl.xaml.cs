...
{
    /// <summary>
    /// 大面贴胶检测Station2DCtrl.xaml 的交互逻辑
    /// </summary>
    public partial class 大面贴胶检测Station2DCtrl : UserControl, INotifyPropertyChanged
    {
        public 大面贴胶检测Station2DCtrl()
        {
            InitializeComponent();
        }
        ...
        public static readonly DependencyProperty DevMsgProperty =
            DependencyProperty.Register("DevMsg", typeof(DevMsg_2DStation), typeof(大面贴胶检测Station2DCtrl), new PropertyMetadata(null, DevMsgCallBack));
        ...
        {
            if (d is 大面贴胶检测Station2DCtrl ctrl)
            {
        ...
        public static readonly DependencyProperty MstMsgProperty =
            DependencyProperty.Register("MstMsg", typeof(MstMsg_2DStation), typeof(大面贴胶检测Station2DCtrl), new PropertyMetadata(null, MstMsgCallBack));
