...
{
    /// <summary>
    /// 大面贴胶检测Station2DSpotCtrl.xaml 的交互逻辑
    /// </summary>
    public partial class 大面贴胶检测Station2DSpotCtrl : UserControl, INotifyPropertyChanged
    {
        public 大面贴胶检测Station2DSpotCtrl()
        {
            InitializeComponent();
        }
        ...
        public static readonly DependencyProperty DevMsgProperty =
            DependencyProperty.Register("DevMsg", typeof(DevMsg_2DSpotStation), typeof(大面贴胶检测Station2DSpotCtrl), new PropertyMetadata(null, DevMsgCallBack));
        ...
        {
            if (d is 大面贴胶检测Station2DSpotCtrl ctrl)
            {
        ...
        public static readonly DependencyProperty MstMsgProperty =
            DependencyProperty.Register("MstMsg", typeof(MstMsg_2DSpotStation), typeof(大面贴胶检测Station2DSpotCtrl), new PropertyMetadata(null, MstMsgCallBack));
        ...
        public static readonly DependencyProperty PrefixProperty =
            DependencyProperty.Register("Prefix", typeof(string), typeof(大面贴胶检测Station2DSpotCtrl), new PropertyMetadata(""));
